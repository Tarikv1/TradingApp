<?php
// Database configuration for StockWizard with updated Firebase integration
...
// API Configuration with updated Firebase details
class APIConfig {
    const MARKETSTACK_API_KEY = 'YOUR_MARKETSTACK_API_KEY';
    const MARKETSTACK_BASE_URL = 'http://api.marketstack.com/v1';
    
    // Updated Firebase configuration
    const FIREBASE_PROJECT_ID = 'project-955111037759';
    const FIREBASE_API_KEY = 'AIzaSyCVlSQati-LvVgwx-LSAv5JLUCNEHAYWt8';
    const FIREBASE_AUTH_DOMAIN = 'project-955111037759.firebaseapp.com';
    const GOOGLE_CLIENT_ID = '955111037759-5qpkd92ofaa1nsi52sgr0e11gi5mmfhl.apps.googleusercontent.com';
